...
Session.prototype._processFlowFrame = function(frame) {
  ...
  if (frame.handle !== null) {
    ...
    u.objectMap(this._senderLinks, function(senderLink) {
...
Session.prototype._beginReceived = function(frame) {
  ...
  u.objectMap(this._senderLinks, attachHandler);
  u.objectMap(this._receiverLinks, attachHandler);
};
...
Session.prototype._unmap = function() {
  if (this.connection !== undefined && this.channel !== undefined) {
    ...
    u.objectMap(this._senderLinks, detachHandler);
    u.objectMap(this._receiverLinks, detachHandler);
    this._linksByRemoteHandle = {};
    this._allocatedHandles = {};
...
Session.prototype._handleDisposition = function(frame) {
  ...
  var collection = (frame.role === constants.linkRole.sender) ?
    this._receiverLinks : this._senderLinks;
  u.objectMap(collection, dispositionHandler);
...
Session.prototype._resetLinkState = function() {
  ...
  u.objectMap(this._senderLinks, forceDetachLink);
  u.objectMap(this._receiverLinks, forceDetachLink);
};
