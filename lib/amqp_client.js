...
AMQPClient.prototype.registerSaslMechanism = function(mechanism, handler) {
  ...
  if (!handler.getInitFrameContent || !handler.getChallengeResponseContent) {
    throw new ReferenceError('the handler object must implement getInitFrameContent and getChallengeResponseContent');
  }
